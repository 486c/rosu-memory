    ...
    try {
        ...
        switch (data.state) {
            ...
            case 2:
                ...
                // Sliderbreak
                if (play.slider_breaks >= 1) {
                    sb.update(play.slider_breaks);
                ...
                // PP FC
                if (play.slider_breaks >= 1 || play.hit_miss >= 1) {
                    fc.update(data.fc_pp);
                ...
                pp.update(data.current_pp);
                h100.update(play.hit_100);
                h50.update(play.hit_50);
                h0.update(play.hit_miss);
                break;
            case 0:
                //Main
